...
const PerformanceReportsForecasts = () => {
    return (
            ...
            <div className="p-6 lg:p-8 space-y-8 max-w-7xl mx-auto w-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p className="text-3xl font-bold text-slate-900 dark:text-slate-100">45 280 DT</p>
                        <p className="text-xs text-slate-400 mt-2">vs 40 428 DT le mois dernier</p>
                    </div>
                    ...
                    <div className="bg-primary/5 dark:bg-primary/10 p-6 rounded-xl border border-primary/20 dark:border-primary/40 shadow-sm md:col-span-2">
                        <div className="flex items-center justify-between mb-4">
                        ...
                        <p className="text-3xl font-bold text-slate-900 dark:text-slate-100">48 500 DT</p>
                        <div className="mt-4 space-y-2">
                            <div className="flex justify-between text-[11px]">
                                <span className="text-slate-500">Réservations confirmées</span>
                                <span className="font-semibold text-slate-700 dark:text-slate-300">38 200 DT</span>
                            </div>
                            <div className="flex justify-between text-[11px]">
                                <span className="text-slate-500">Croissance estimée (+7%)</span>
                                <span className="font-semibold text-slate-700 dark:text-slate-300">10 300 DT</span>
                            </div>
                        ...
                        <div className="space-y-6">
                            <div className="space-y-2">
                                <div className="flex justify-between text-sm">
                                    ...
                                    <span className="font-bold text-slate-900 dark:text-slate-100">12 400 DT</span>
                                </div>
                            ...
                            <div className="space-y-2">
                                <div className="flex justify-between text-sm">
                                    ...
                                    <span className="font-bold text-slate-900 dark:text-slate-100">9 850 DT</span>
                                </div>
                                <div className="w-full bg-slate-100 dark:bg-slate-800 h-2.5 rounded-full overflow-hidden">
                            ...
                            <div className="space-y-2">
                                <div className="flex justify-between text-sm">
                                    ...
                                    <span className="font-bold text-slate-900 dark:text-slate-100">7 200 DT</span>
                                </div>
                                <div className="w-full bg-slate-100 dark:bg-slate-800 h-2.5 rounded-full overflow-hidden">
                            ...
                            <div className="space-y-2">
                                <div className="flex justify-between text-sm">
                                    ...
                                    <span className="font-bold text-slate-900 dark:text-slate-100">4 100 DT</span>
                                </div>
                                <div className="w-full bg-slate-100 dark:bg-slate-800 h-2.5 rounded-full overflow-hidden">
                ...
                <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
                        ...
                        <table className="w-full text-left">
                            ...
                            <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                                <tr className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                                    ...
                                    <td className="px-6 py-4 text-sm font-bold text-slate-900 dark:text-slate-100">14 250 DT</td>
                                    <td className="px-6 py-4 text-sm text-slate-700 dark:text-slate-300">339 DT / vh</td>
                                    <td className="px-6 py-4">
                                ...
                                <tr className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                                    ...
                                    <td className="px-6 py-4 text-sm font-bold text-slate-900 dark:text-slate-100">18 400 DT</td>
                                    <td className="px-6 py-4 text-sm text-slate-700 dark:text-slate-300">657 DT / vh</td>
                                    <td className="px-6 py-4">
                                ...
                                <tr className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                                    ...
                                    <td className="px-6 py-4 text-sm font-bold text-slate-900 dark:text-slate-100">12 630 DT</td>
                                    <td className="px-6 py-4 text-sm text-slate-700 dark:text-slate-300">1 052 DT / vh</td>
                                    <td className="px-6 py-4">
                    ...
                    <div className="px-6 py-4 bg-slate-50 dark:bg-slate-900/50 flex flex-col sm:flex-row items-center justify-between gap-4">
                        <p className="text-xs text-slate-500 dark:text-slate-400 text-center sm:text-left">Données calculées en temps réel sur la base des contrats clôturés.</p>
...
export default PerformanceReportsForecasts;
