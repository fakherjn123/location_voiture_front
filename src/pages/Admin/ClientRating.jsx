    ...
    return (
        <div className="space-y-8 max-w-7xl mx-auto w-full">
                ...
                <div className="flex items-center gap-6">
                    ...
                    <div>
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex items-center gap-1 bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 px-2 py-0.5 rounded border border-blue-100 dark:border-blue-800">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                {/* Left Column: Personal Info, Documents, Rating */}
                    ...
                    <section className="bg-white dark:bg-slate-900 rounded-xl p-6 border border-slate-200 dark:border-slate-800 shadow-sm">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between mb-2">
                                <div className="flex items-center gap-1 text-amber-500" style={{ fontVariationSettings: "'FILL' 1" }}>
                                ...
                                <span className="text-lg font-bold text-slate-900 dark:text-slate-100">4.8 / 5</span>
                            </div>
                            ...
                            <div className="pt-4 mt-4 border-t border-slate-100 dark:border-slate-800">
                                <label className="text-[10px] uppercase font-bold text-slate-500 block mb-2">Note Interne Récente</label>
                                <p className="text-xs text-slate-600 dark:text-slate-400 italic bg-slate-50 dark:bg-slate-800/50 p-3 rounded-lg border border-slate-100 dark:border-slate-800">
                                    "Client très soigneux. Véhicule rendu propre et avec le plein fait. Très bonne communication lors de la prolongation."
                                </p>
                            </div>
                        </div>
                    </section>
                ...
                <div className="lg:col-span-2">
                    <section className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 flex flex-col h-full shadow-sm overflow-hidden">
                        ...
                        <div className="overflow-x-auto flex-1">
                            <table className="w-full text-left">
                                ...
                                <tbody className="divide-y divide-slate-100 dark:divide-slate-800 min-h-[300px]">
                                    ...
                                    <tr className="hover:bg-slate-50/50 dark:hover:bg-slate-800/30 transition-colors">
                                        <td className="px-6 py-4">
                                            <p className="text-sm font-medium text-slate-900 dark:text-slate-100">15/12/2023</p>
                                            <p className="text-[10px] text-slate-500">3 Jours</p>
                                        </td>
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                <div className="w-10 h-10 rounded bg-slate-200 dark:bg-slate-800 flex items-center justify-center overflow-hidden shrink-0">
                                                ...
                                                <div>
                                                    <p className="text-sm font-medium text-slate-900 dark:text-slate-100">Mercedes Classe C</p>
                                                    <p className="text-[10px] text-slate-500">Essence DT MC-505-AA</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4 text-sm font-bold text-slate-900 dark:text-slate-100">DT410.00</td>
                                        <td className="px-6 py-4">
                                            <span className="px-2 py-1 rounded-full text-[10px] font-bold bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-800">Completed</span>
                                        </td>
                                        <td className="px-6 py-4 text-right">
                        ...
                        <div className="p-4 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between bg-slate-50/50 dark:bg-slate-800/20">
                            <p className="text-[10px] text-slate-500">Affichage de 4 sur 24 locations</p>
                            <div className="flex gap-2">
